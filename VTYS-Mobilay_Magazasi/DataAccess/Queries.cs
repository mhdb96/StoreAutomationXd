...
namespace DataAccess
{
    ...
    class Queries
    {
        ...
        readonly public static string attributeSetName = "SELECT set_name FROM attributeset where attributeSet_ID ={0};";
        ...
        readonly public static string last5Sell = "SELECT concat(c.cus_name, ' ', c.cus_lastName)as name, p.pro_name,s.sel_price, s.sel_qty FROM sell s join customer c on c.customer_ID = s.customer_customer_ID join product p on p.product_ID = s.product_product_ID ORDER BY sell_ID DESC LIMIT 5;";

        readonly public static string districtsCount = "SELECT count(*) FROM district;";
        readonly public static string dis_cusCount = "SELECT count(*) FROM customer where district_district_ID = {0};";
        readonly public static string districtData = "SELECT district_ID, dis_name FROM district;";
        readonly public static string districName = "SELECT concat(dis_name ,' - ', prov_name)as name FROM district d join province p on p.province_ID = d.province_province_ID where d.district_ID ={0};";

        readonly public static string buyCount = "SELECT count(*) FROM buy;";
        readonly public static string buy_supCount = "SELECT count(*) FROM buy where supplier_supplier_ID ={0};";
        ...
        readonly public static string ordersCustomers = "SELECT customer_ID, concat(cus_name, ' ', cus_lastName) as name FROM customer;";
        readonly public static string ordersProducts = "SELECT product_ID, pro_name FROM product;";
        readonly public static string ordersSuppliers = "SELECT supplier_ID, sup_name FROM supplier;";
        ...
        readonly public static string activity = "SELECT activity_ID ,act_name FROM activity where activityType_activityType_ID ={0};";
        ...
        readonly public static string attributeLike = "SELECT attribute_ID as \"ID\", att_name as \"Name\" FROM attribute WHERE att_name LIKE '%{0}%' order by ID;";
        readonly public static string delAttribute = "DELETE FROM attribute  WHERE (attribute_ID = {0});";
        readonly public static string attribute2 = "SELECT attribute_ID as \"ID\", att_name as \"Name\" FROM attribute order by attribute_ID;";
        ...
        //======================= ATTRIBUTE SET =======================
        //=============================================================
        readonly public static string attributeSet2 = "SELECT attributeSet_ID as \"ID\", set_name as \"Name\" FROM attributeset order by ID;";
        ...
        readonly public static string attributeSetLike = "SELECT attributeSet_ID as \"ID\", set_name as \"Name\" FROM attributeset WHERE set_name LIKE '%{0}%' order by ID;";
        ...
        //======================= ATTRIBUTE VAlUES ====================
        //=============================================================
        readonly public static string attributeValues2 = "SELECT attribute_ID as \"ID\" ,att_name as \"Name\" FROM attribute;";
        ...
        readonly public static string attributeValueLike2 = "SELECT attributeValue_ID as \"ID\", val_value as \"Name\" FROM attributevalue WHERE val_value LIKE '%{0}%' AND attribute_attribute_ID={1} order by ID;";

        //=============================================================
        //======================= PROVINCE ============================
        //=============================================================
        readonly public static string province = "SELECT province_ID as \"ID\", prov_name as \"Name\" FROM province order by ID;";
        ...
        readonly public static string provinceLike = "SELECT province_ID as \"ID\", prov_name as \"Name\" FROM province WHERE prov_name LIKE '%{0}%' order by ID;";
        ...
        readonly public static string districtLike = "SELECT district_ID as \"ID\", dis_name as \"Name\" FROM district WHERE dis_name LIKE '%{0}%' AND province_province_ID={1} order by ID;";

        //=============================================================
        //======================= EMPLOYEE ============================
        //=============================================================
        readonly public static string employee = "SELECT e.employee_ID, e.emp_name , e.emp_lasName,e.emp_TC,e.emp_telephone,e.emp_adress, d.dis_name, p.prov_name , de.dep_name, e.emp_salary FROM employee e JOIN district d on d.district_ID=e.district_district_ID JOIN province p on p.province_ID=e.province_province_ID JOIN department de on de.department_ID=e.department_department_ID;";
        ...
        readonly public static string employeeLike = "SELECT e.employee_ID, e.emp_name , e.emp_lasName,e.emp_TC,e.emp_telephone,e.emp_adress, d.dis_name, p.prov_name , de.dep_name, e.emp_salary FROM employee e JOIN district d on d.district_ID=e.district_district_ID JOIN province p on p.province_ID=e.province_province_ID JOIN department de on de.department_ID=e.department_department_ID WHERE e.emp_name LIKE '%{0}%';";
        readonly public static string delEmployee = "DELETE FROM employee WHERE (employee_ID = {0});";
        readonly public static string employee2 = "SELECT e.employee_ID as \"ID\", e.emp_name  as \"Name\", e.emp_lasName as \"Last Name\",e.emp_TC as \"TC\",e.emp_telephone as \"Tel\",e.emp_adress as \"Adress\", d.dis_name as \"District\", p.prov_name  as \"Province\", de.dep_name as \"Department\", e.emp_salary  as \"Salary\" FROM employee e JOIN district d on d.district_ID=e.district_district_ID JOIN province p on p.province_ID=e.province_province_ID JOIN department de on de.department_ID=e.department_department_ID;";

        //=============================================================
        //======================= DEPARTMENT ==========================
        //=============================================================
        readonly public static string department = "SELECT department_ID as \"ID\", dep_name as \"Name\" FROM department order by ID;";
        ...
        readonly public static string departmentLike = "SELECT department_ID as \"ID\", dep_name as \"Name\" FROM department WHERE dep_name LIKE '%{0}%' order by ID;";
        readonly public static string delDepartment = "DELETE FROM department WHERE (department_ID = {0});";

        //=============================================================
        //======================= ACTIVITY ============================
        //=============================================================
        readonly public static string activityType = "SELECT activityType_ID as \"ID\" ,actty_name as \"Name\" FROM activitytype;";
        ...
        //readonly public static string activity = "SELECT * FROM activity order by activity_ID;";
        ...
        readonly public static string activityLike = "SELECT activity_ID as \"ID\", act_name as \"Name\" FROM activity WHERE act_name LIKE '%{0}%' AND activityType_activityType_ID={1} order by ID;";
        readonly public static string delActivity = "DELETE FROM activity WHERE (activity_ID = {0});";

        //readonly public static string ttributeValueLike = "SELECT attribute_ID as \"ID\", att_name as \"Name\" FROM attribute WHERE att_name LIKE '%{0}%' order by ID;";
