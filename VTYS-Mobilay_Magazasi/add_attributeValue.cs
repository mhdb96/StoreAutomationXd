...
namespace VTYS_Mobilay_Magazasi
{
    public partial class add_attributeValue : MetroForm
    {
        ...
        private void metroButton1_Click_1(object sender, EventArgs e)
        {
            ...
            string Attributetext = attributeValueList.Text;
            if (!update)
            {
                string query2 = String.Format(Queries.attribute_id, Attributetext);
                string query = String.Format(Queries.insAttributeValue, Id, Name, query2);
            ...
            else
            {
                ...
                string query2 = String.Format(Queries.attribute_id, Attributetext);
                string query = String.Format(Queries.upAttributeValue, Name, query2, Id);
                DbCommand.insertIntoDb(query);
            }
            this.Close();
        }
